...
const words2 = `Since then, I've gained valuable experience through studying, personal projects and freelance work, focusing on building web applications that prioritize functionality. This hands-on experience has allowed me to refine my skills and deepen my understanding of various technologies.`;
const words3 = `Continuously seeking to enhance my skills, I work on personal projects using a range of technologies. These projects not only serve as a creative outlet but also as a means to stay up-to-date with the latest trends and tools in web development. 
`;
      ...
      <div className="flex justify-between items-center px-48 pt-6 z-10">
        ...
        >
          ...
          <div className="flex flex-col text-slate-200">
            <h2 className="text-2xl font-semibold underline-offset-8 underline decoration-pink-500 decoration-4">
              Frontend Dev
            </h2>
        ...
        >
          ...
          <div className="flex flex-col text-slate-200">
            <h2 className="text-2xl font-semibold underline-offset-8 underline decoration-orange-500 decoration-4">
              Software Development
            </h2>
            <p className="text-xl pt-1">
              Experienced in functional programming: JavaScript, TypeScript.
            </p>
          </div>
        </motion.div>
      </div>
